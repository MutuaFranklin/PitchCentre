...
Revision ID: cc413aeafbbc
Revises: 74d9157016d4
Create Date: 2021-08-13 14:45:00.073126
...
revision = 'cc413aeafbbc'
down_revision = '74d9157016d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('categories_title', sa.String(), nullable=True),
